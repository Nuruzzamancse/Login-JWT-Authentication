...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_dahsboard_dahsboard_component__ = __webpack_require__("./src/app/components/dahsboard/dahsboard.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_angular_flash_message__ = __webpack_require__("./node_modules/angular-flash-message/dist/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_angular_flash_message___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_14_angular_flash_message__);
...
var appRoutes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_9__components_dahsboard_dahsboard_component__["a" /* DahsboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__gaurds_auth_gaurd__["a" /* AuthGaurd */]] },
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_10__components_profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__gaurds_auth_gaurd__["a" /* AuthGaurd */]] },
];
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__components_dahsboard_dahsboard_component__["a" /* DahsboardComponent */],
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_14_angular_flash_message__["FlashMessageModule"]
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_12__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_13__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_15__gaurds_auth_gaurd__["a" /* AuthGaurd */]],
...
/***/ "./src/app/components/dahsboard/dahsboard.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/components/dahsboard/dahsboard.component.html":
/***/ (function(module, exports) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DahsboardComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var DahsboardComponent = /** @class */ (function () {
    function DahsboardComponent() {
    }
    DahsboardComponent.prototype.ngOnInit = function () {
    };
    DahsboardComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-dahsboard',
            template: __webpack_require__("./src/app/components/dahsboard/dahsboard.component.html"),
            styles: [__webpack_require__("./src/app/components/dahsboard/dahsboard.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], DahsboardComponent);
    return DahsboardComponent;
}());
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                _this.authService.storeUserDatta(data.token, data.user);
                _this.flashMessage.success('You are now logged in', { delay: 3000 });
                _this.router.navigate(['dashboard']);
            }
            else {
                _this.flashMessage.warning(data.msg, { delay: 3000 });
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.success('You are registered and can login', { delay: 2000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessage.warning('Something went wrong', { delay: 2000 });
